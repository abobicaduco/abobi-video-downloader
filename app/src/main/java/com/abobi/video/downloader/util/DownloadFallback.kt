    ...
    private fun tiktokStrategies(
        ...
        strategies.addAll(
            listOf(
                ...
                Strategy("tiktok-api-hostname-east1a") { prefs ->
                    applyUserAgent(this, TIKTOK_APP_UA, prefs)
                    addOption("--sleep-requests", "1")
                    addOption("--extractor-args", "tiktok:api_hostname=api16-normal-c-useast1a.tiktokv.com")
                },
                Strategy("tiktok-api-hostname-east2a") { prefs ->
                    applyUserAgent(this, TIKTOK_APP_UA, prefs)
                    addOption("--sleep-requests", "2")
                    addOption("--extractor-args", "tiktok:api_hostname=api16-normal-c-useast2a.tiktokv.com")
                },
                Strategy("tiktok-api-hostname-api22") { prefs ->
                    applyUserAgent(this, TIKTOK_APP_UA, prefs)
                    addOption("--sleep-requests", "2")
                    addOption("--extractor-args", "tiktok:api_hostname=api22-normal-c-useast1a.tiktokv.com")
                },
                Strategy("minimal-ua") { prefs ->
                    applyUserAgent(this, "TikTok 26.0", prefs)
                    addOption("--sleep-requests", "2")
                    addOption("--add-header", "Referer:https://www.tiktok.com/")
                },
